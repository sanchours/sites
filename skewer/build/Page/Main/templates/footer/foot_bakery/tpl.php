...
<div class="l-footerbox"<?= Design::write(' sktag="page.footer"'); ?>>
    ...
    <div class="footerbox__wrapper js_dnd_wraper">
        <div class="l-grid">
            ...
            <div class="grid__item2 hide-on-mobile<?php if (Design::modeIsActive()): ?> g-ramaborder js-designDrag-<?= Design::get('page.footer.grid2', 'h_position'); ?>" sktag="page.footer.grid2" skeditor="counters/source<?php endif; ?>">
                <?php if (Design::modeIsActive()): ?>
            ...
            <div class="grid__item4 hide-on-mobile<?php if (Design::modeIsActive()): ?> g-ramaborder js-designDrag-<?= Design::get('page.footer.grid4', 'h_position'); ?>" sktag="page.footer.grid4" skeditor="footertext4/source<?php endif; ?>">
                <?php if (Design::modeIsActive()): ?>
