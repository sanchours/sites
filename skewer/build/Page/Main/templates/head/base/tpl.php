...
<div class="l-header">
    <div class="header__wrapper js_dnd_wraper">
        <div class="b-pilot" <?= Design::write(' sktag="page.head" sklayout="head"'); ?>>
            ...
            <div class="pilot__1 <?php if (Design::modeIsActive()) : ?>g-ramaborder js-designDrag-<?= Design::get('page.head.pilot1', 'h_position'); ?>" sktag="page.head.pilot1" skeditor="headtext1/source<?php endif; ?>"><?= Page::getShowVal('headtext1', 'source'); ?>
                <?php if (Design::modeIsActive()) : ?>
...
<? if (isset($layout['fixed_menu']) and !empty($layout['fixed_menu'])) : ?>
