...
use skewer\build\Page\CategoryViewer\templates\standard2;
...
standard2\Asset::register(Yii::$app->view, ['aActiveSections' => ArrayHelper::getColumn($list, 'id')]);
?>

<div class="b-category b-category_abstitle <?php if (!empty($html_class)): ?><?= $html_class ?> <?php endif; ?>">
    <?php if ($title): ?>
        <h2><?= $title ?></h2>
    <?php endif; ?>
    <div class="category__items">
        <?php  foreach ($list as $aItem): ?>
            ...
            <div class="category__item section_<?=$aItem['id']; ?> ">
