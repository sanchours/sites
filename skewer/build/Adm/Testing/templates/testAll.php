#!/bin/bash
echo -en "\033[37;1;41m Вы запустили все тесты \033[0m \n"
cd <?= $pathToSite . "\n"; ?>
...
for nameFile in `find $serverPath/tests/acceptanceKS/Test\ Suites/ -type f -name "*.ts"| cut -d'.' -f1| sed 's/[[:space:]]/\\&/g'`
do
...
echo "\033[37;1;33m Закончилась обработка теста - \033[0m "$sortPathTest"\033[0m \n"
done
