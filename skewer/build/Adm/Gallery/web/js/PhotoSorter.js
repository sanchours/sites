...
/**
 * Плагин для сортировки контерна на основе ExtJS
 */
//noinspection JSUnusedGlobalSymbols
Ext.define('Ext.Adm.PhotoSorter',{
    ...
    _createDragDrop : function(){
        this.dragZone = new Ext.dd.SortableDragZone(this.container, {ddGroup : this.dragGroups[0], scroll:false, containerScroll:false, queryString : this.queryString});
     ...
     * @public
     * @param {Boolean|undefined} flag Switch flag to fire event or not
     ...
     * @public
     * @param {String|Array} from The DD Group(s) you want to swap the list from
     * @param {String|Array} to The DD Group(s) you want to swap the list to
     */
     ...
     * @public
     * @param {String|Array} groupName DD group(s) you want to add your list to
     * @param [enable]
     */
     ...
     * @public
     * @param {String|Array} groupName DD group(s) you want to remove your list from
     * @param [enable]
     */
...
Ext.extend(Ext.dd.SortableDragZone, Ext.dd.DragZone, {
    ...
    onInitDrag : function(x, y){
        ...
        if( Ext.isIE )
            ...
            this.dragData.ddel.style.opacity = 0.2;
        return true;
    },
    ...
    afterRepair : function(){
        if( Ext.isIE )
            ...
            this.dragData.ddel.style.opacity = '';
        this.dragging = false;
    },
...
Ext.extend(Ext.dd.SortableDropZone, Ext.dd.DropZone, {
    ...
    notifyEnter : function(source, e, data){
        ...
        if(this._testDDGroup()){
            ...
            if(this.srcEl !== null){
                if(this.srcEl.dom.parentNode!==null && this.srcEl.dom.parentNode !== this.el.dom){
    ...
    onNodeOver : function(n, dd, e, data){
        if(this._testDDGroup()){
            ...
            if (this.goingPrevious) {
                ...
                if( this.srcEl.id != destEl.id )
                    this.picDDGroup.curPack = {itemId:this.srcEl.id, targetId:destEl.id, orderType:'before'};
            } else {
                this.srcEl.insertAfter(destEl);
                if( this.srcEl.id != destEl.id )
                    this.picDDGroup.curPack = {itemId:this.srcEl.id, targetId:destEl.id, orderType:'after'};
            }
