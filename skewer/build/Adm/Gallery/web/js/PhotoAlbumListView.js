 ...
 */
Ext.define('PhotoAlbumListModel', {
...
Ext.define('Ext.Adm.PhotoAlbumListView', {
    ...
    plugins: [
        ...
        Ext.create('Ext.Component',{
            ...
            onClick: function(e, target) {
                ...
                var index = Ext.Array.indexOf(classList, 'js_album_check');
    ...
    initComponent: function(){
        var me = this;
        me.emptyText = '<div class="empty-cont">' + me.lang.galleryNoAlbums + '</div>';
        me.callParent();
    },

    store: {
        model: 'PhotoAlbumListModel',
        data: []
    },
    ...
    tpl: [
        '<tpl for=".">',
            '<div class="thumb-wrap x-thumb-wrap" id="horizontal_sort{id}">',
                ...
                '<span class="x-editable">{header_info}<br>{title}</span>',
                '<input class="js_album_check x-img_check" type="checkbox" name="hact_alb{id}" value="1" {active}>',
            '</div>',
        '</tpl>',
    ...
    prepareData: function(data) {
        Ext.apply(data, {
            shortName: Ext.util.Format.ellipsis(data.name, 220),
