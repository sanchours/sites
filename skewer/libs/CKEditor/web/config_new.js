...
CKEDITOR.editorConfig = function (config) {
    ...
    CKEDITOR.plugins.addExternal( 'mediaembed', `${ckedir}/plugins/mediaembed/`, 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'video', `${ckedir}/plugins/video/`, 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'UploadManager', `${ckedir}/plugins/UploadManager/`, 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'widget', `${ckedir}/plugins/widget/`, 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'iframe', `${ckedir}/plugins/iframe/`, 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'table', `${ckedir}/plugins/table/`, 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'tabletools', `${ckedir}/plugins/tabletools/`, 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'tableresize', `${ckedir}/plugins/tableresize/`, 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'contenteditor', `${ckedir}/plugins/contenteditor/`, 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'fontawesome', `${ckedir}/plugins/fontawesome/`, 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'codemirror', `${ckedir}/plugins/codemirror/`, 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'codemirror', `${ckedir}/plugins/codemirror/`, 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'popupform', `${ckedir}/plugins/popupform/`, 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'tooltip2', `${ckedir}/plugins/tooltip2/`, 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'tipograf', `${ckedir}/plugins/tipograf/`, 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'tipograf_all_text', `${ckedir}/plugins/tipograf_all_text/`, 'plugin.js' );
    ...
    if (config.lock_tooltip_module=='0'){
    ...
    CKEDITOR.lang.load(config.language, 'en', function(){
        if (typeof CKEDITOR.lang[String(config.language)] != 'undefined'){
            CKEDITOR.lang[String(config.language)] = _.merge(
    ...
    CKEDITOR.on('dialogDefinition', function( ev ) {
        ...
        if(dialogName === 'table') {
            ...
            const cellSpacing = infoTab.get('txtCellSpace');
            cellSpacing['default'] = "";
            const cellPadding = infoTab.get('txtCellPad');
            cellPadding['default'] = "";
