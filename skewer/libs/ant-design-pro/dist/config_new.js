...
CKEDITOR.editorConfig = function (config) {
    ...
    CKEDITOR.plugins.addExternal( 'UploadManager', '/plugins/UploadManager/', 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'widget', '/plugins/widget/', 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'iframe', '/plugins/iframe/', 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'table', '/plugins/table/', 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'tabletools', '/plugins/tabletools/', 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'tableresize', '/plugins/tableresize/', 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'contenteditor', '/plugins/contenteditor/', 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'fontawesome', '/plugins/fontawesome/', 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'codemirror', '/plugins/codemirror/', 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'codemirror', '/plugins/codemirror/', 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'popupform', '/plugins/popupform/', 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'tooltip2', '/plugins/tooltip2/', 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'tipograf', '/plugins/tipograf/', 'plugin.js' );
    CKEDITOR.plugins.addExternal( 'tipograf_all_text', '/plugins/tipograf_all_text/', 'plugin.js' );
