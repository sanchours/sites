...
public class ArticlesData {
	...
	String аtext = 'Анонсный текст статьи';
	String ftext = 'Полный текст статьи';
	...
	void setChangeData() {
		...
		title = 'Редактированное название статьи';
		аtext = 'Редактированный анонсный текст статьи';
		ftext = 'Редактированный полный текст статьи';
	}
}
