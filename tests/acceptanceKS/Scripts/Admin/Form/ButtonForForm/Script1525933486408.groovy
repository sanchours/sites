 ...
 * @step Установка значение в параметр "Кнопка для формы"
 ...
 * @step Проверка названия кнопки на форме
...
WebUI.setText(findTestObject('CMS/Form/ButtonForForm/input_form_button'), Text)
...
WebUI.verifyElementText(findTestObject('CMS/Form/ButtonForForm/button_on_form'), Text)
