...
if (WebUI.verifyElementChecked(findTestObject('CMS/Form/CheckboxLicenseAgreement/input_license_agreement_checkbox'), 3, 
    ...
    WebUI.verifyElementNotPresent(findTestObject('CMS/Form/CheckboxLicenseAgreement/div_checkbox_license_agreement_on_page'), 
        3)
} else {
    WebUI.click(findTestObject('CMS/Form/CheckboxLicenseAgreement/span_save'))
