 ...
 * @step Установка галочки "Выводить название формы"
 ...
 * @step Проверка наличия блока с названием формы и его соответствие названию, заданному в админской части 
...
import groovy.swing.factory.TitledBorderFactory as TitledBorderFactory
...
if (WebUI.verifyElementChecked(findTestObject('CMS/Form/ShowForrmHeader/input_form_header'), 0, FailureHandling.OPTIONAL) ==
	true) {
...
WebUI.verifyElementText(findTestObject('CMS/Form/ShowForrmHeader/h2_form_header'), Title)
