 /**
 * @description Клонирование формы
 ...
 * @step Копирование формы
 * @step Проверка того, что форма скопирована
...
WebUI.click(findTestObject('CMS/Form/CloneForm/div_clone_form'))

WebUI.verifyElementVisible(findTestObject('CMS/Form/CloneForm/div_clone_form_in_list'), FailureHandling.STOP_ON_FAILURE)
