 /**
 * @description Базовая результирующая страница
 * @step Переход на детальную формы 
 * @step Переход в настройки результирующей
 * @step Выбор базовой результирующей
...
WebUI.click(findTestObject('CMS/Form/ResultPage/li_base'))
...
WebUI.verifyElementVisible(findTestObject('CMS/Form/ResultPage/div_base_result_on_page'))
