...
for (int numberField = 1; numberField <= (countListTypeField - 2); numberField++) {
    switch (numberField) {
        case 1:
            ...
            WebUI.verifyElementVisible(findTestObject('CMS/Form/RequiredParametr/div_error_message_fields'))
        ...
        case 7:
            ...
            WebUI.setText(findTestObject('CMS/Form/CheckSendFormOnPage/input_multiline_text_field'), DataForm.date)
