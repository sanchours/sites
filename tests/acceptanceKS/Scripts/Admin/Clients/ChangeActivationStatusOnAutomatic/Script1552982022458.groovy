/**
 * @description Изменение статуса активации клиента на автоматическое подтверждение 
 * @step Переход в раздел клиенты
 * @step Переход в меню изменения статуса, выбор первого способа авторизации в списке и сохранение
