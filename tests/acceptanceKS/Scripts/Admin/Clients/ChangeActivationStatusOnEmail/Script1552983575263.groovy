/**
 * @description Изменение статуса активации клиента на подтверждение по почте
 * @step Переход в раздел клиенты
 * @step Переход в меню изменения статуса, выбор второго способа авторизации в списке и сохранение
