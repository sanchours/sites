 /**
 * @description Проверка активности ВИО на сайте
 ...
 * @step Проверяем соответствие текста вопроса и ответа у первого ВИО
...
WebUI.verifyElementText(findTestObject('Site/FAQ/CheckFAQ/a_first_faq'), DataFAQ.question)

WebUI.verifyElementText(findTestObject('Site/FAQ/CheckFAQ/div_answer_on_site'), 'Ответ: ' + DataFAQ.answer)
