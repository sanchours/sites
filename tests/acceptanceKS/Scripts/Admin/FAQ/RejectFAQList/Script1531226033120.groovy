 /**
 * @description Отклонение ВИО выпадающим списком
 * @step Переход по первой новости в списке
 * @step Нажатие на открытие списка статус
 * @step Выбор третьего элемента выпадающего списка
...
WebUI.click(findTestObject('CMS/FAQ/ChangeStatusFAQ/li_reject_faq_list'))
