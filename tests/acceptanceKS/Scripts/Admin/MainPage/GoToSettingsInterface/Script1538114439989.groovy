/**
 * @description Переход в интерфейс настроек параметров
 * @step Переход в верхнее меню
 * @step Переход на главную
 * @step Переход в интерфейс редактирования параметров на главной
 */
...
WebUI.click(findTestObject('CMS/MainPage/GoToSettingsInterface/div_tab_settings'))
