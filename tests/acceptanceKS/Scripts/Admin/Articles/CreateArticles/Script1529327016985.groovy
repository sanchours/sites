 ...
 * @step Заполнение полей Название, Анонс, Полный текст, Автор, Источник и Псевдоним
...
WebUI.setText(findTestObject('CMS/Articles/CheckAuthor/input_author_articles'), DataArticles.author)

WebUI.setText(findTestObject('CMS/Articles/CheckSourcelinkArticles/input_source_link_articles'), DataArticles.link)

WebUI.setText(findTestObject('CMS/Articles/CheckAliasArticle/input_articles_alias'), DataArticles.alias)
