 /**
 * @description Создание раздела статьи
 * @step Жмем кнопку добавить раздел
 * @step Заполнение полей название и псевдоним раздела
 * @step Раскрытие списка тип раздела и выбор четвертой строчки в выпадающем окне
...
WebUI.setText(findTestObject('CMS/News/CreateNewNews/CreateNewSection/input_title_section'), DataArticles.titlesection)

WebUI.setText(findTestObject('CMS/Tree/NewSection/input_alias'), DataArticles.aliassection)

WebUI.click(findTestObject('CMS/News/CreateNewNews/CreateNewSection/span_section_type'))

WebUI.click(findTestObject('CMS/Articles/CreateArticles/span_section_type_articles'))
