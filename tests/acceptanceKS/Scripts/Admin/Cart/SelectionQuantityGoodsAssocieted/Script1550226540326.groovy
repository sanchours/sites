 /**
 * @description Изменение кол-ва товара добавляемых в корзину из списка сопутствующих
...
count = WebUI.getAttribute(findTestObject('Object Repository/CMS/Cart/CountGoods/input_count_goods_associeted'), 'value')
...
WebUI.click(findTestObject('Object Repository/CMS/Cart/CountGoods/div_plus_count_goods_associeted'))
...
WebUI.click(findTestObject('Object Repository/CMS/Cart/CountGoods/div_minus_count_goods_associeted'))
...
WebUI.setText(findTestObject('Object Repository/CMS/Cart/CountGoods/input_count_goods_associeted'), DataCatalog.count)
