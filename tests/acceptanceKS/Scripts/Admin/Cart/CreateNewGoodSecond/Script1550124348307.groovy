/**
 * @description Добавление второго товара 
...
WebUI.setText(findTestObject('CMS/Goods/input_title'), DataCatalog.itemnamesec)

WebUI.setText(findTestObject('CMS/Goods/input_article'), DataCatalog.tecnicalnamesec)

WebUI.setText(findTestObject('CMS/Goods/input_price'), DataCatalog.pricesec)
