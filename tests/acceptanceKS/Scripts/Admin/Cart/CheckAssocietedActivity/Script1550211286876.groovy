/**
 * @description Проверка активности вывода сопутствующих
 * @step Переходим в настройки Каталога
 * @step Кроверяем активность галочки "Сопутствующие товары"
 * @step Переходим в разделы
 */
