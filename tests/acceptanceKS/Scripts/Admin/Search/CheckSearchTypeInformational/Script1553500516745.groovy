  /**
 * @description Проверка типа поиска "Информационный"
 * @step Переход в Панель управления
 * @step Переход в раздел "Поиск"
 * @step Выбираем из выпадающего списка "Тип поиска" второй элемент
 * @step Нажатие на кнопку "Сохранить"
 * @step Открываем новую вкладку на главной странице
 * @step Вводим Nazvanie Tovara в поле мини формы поиска. Жмем кнопку поиска
