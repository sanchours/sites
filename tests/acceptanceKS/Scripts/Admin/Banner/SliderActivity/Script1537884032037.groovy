...
WebUI.click(findTestObject('CMS/Banner/SliderActivity/div_activity'))

WebUI.navigateToUrl(BaseLink.getUrlDef())

WebUI.verifyElementNotPresent(findTestObject('CMS/Banner/SliderActivity/div_slider_on_page'), 0)
