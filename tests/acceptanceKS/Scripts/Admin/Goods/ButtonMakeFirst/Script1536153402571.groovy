...
nameGoods = WebUI.getText(findTestObject('CMS/Goods/ButtonMakeFirst/div_name_last_goods'))

WebUI.click(findTestObject('CMS/Goods/ButtonMakeFirst/button_make_first'))

WebUI.verifyElementText(findTestObject('CMS/Goods/ButtonMakeFirst/div_name_first_goods'), nameGoods)
