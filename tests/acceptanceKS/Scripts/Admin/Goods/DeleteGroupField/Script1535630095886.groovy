...
nameField = WebUI.getText(findTestObject('CMS/Goods/DeleteGroupField/div_name_group'))

WebUI.click(findTestObject('CMS/Goods/DeleteGroupField/button_delete_group_field'))

WebUI.click(findTestObject('CMS/Form/DeleteForm/span_ok'))

WebUI.verifyTextNotPresent(nameField, false)
