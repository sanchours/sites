/**
 * @description Панель сортировки на странице
...
WebUI.click(findTestObject('CMS/Goods/SortingPanelOnPage/checkbox_sorting_panel'))
...
WebUI.click(findTestObject('CMS/Goods/SortingPanelOnPage/div_view_sorting_panel_list'))
...
WebUI.verifyElementVisible(findTestObject('CMS/Goods/SortingPanelOnPage/div_sorting_panel_on_page'))
