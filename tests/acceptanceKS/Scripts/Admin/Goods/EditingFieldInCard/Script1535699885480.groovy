...
for (int numberField = countListTypeField; numberField >= 1; numberField --) {
	
	numberEditField = numberEditField + 1;
	println(numberEditField)
	println(numberField)
	WebUI.delay(3)
	driver.findElement(By.xpath('//div[contains(@class,\'sk-tab-list\')]//table/tbody/tr['+ numberEditField +']/td[4]/div/img[1]')).click()
		
//	oldName = WebUI.getText(findTestObject('CMS/Goods/CreateNewCard/input_name_field'))
	
	if (numberEditField != 5) {
			WebUI.delay(3)
			...
			driver.findElement(By.xpath('//div[contains(@class,\'x-message-box\')]/div[3]/div/div/em[1]/button/span[text()=\'OK\']')).click()
...
//				    WebUI.click(findTestObject('CMS/Goods/CreateNewCard/div_view_type_list'))
//					
//					WebUI.click(findTestObject('Object Repository/CMS/Goods/CreateNewCard/li_wyswyg'))
//					
				WebUI.click(findTestObject('CMS/Goods/CreateNewCard/button_save_new_field'))
