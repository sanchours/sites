...
//if (WebUI.verifyElementChecked(findTestObject('CMS/Goods/CreateNewModifications/checkbox_modifications'), 3, FailureHandling.OPTIONAL)) {
    WebUI.click(findTestObject('CMS/Goods/CreateNewGoodsInSet/input_goods_in_set'))

    WebUI.click(findTestObject('CMS/Goods/CreateNewModifications/button_save_settings'))
//} else {
//.click(findTestObject('CMS/Goods/CreateNewModifications/button_save_settings'))
//}
...
WebUI.click(findTestObject('CMS/Goods/CreateNewGoodsInSet/button_goods_in_set'))

WebUI.click(findTestObject('CMS/Goods/CreateNewGoodsInSet/button_edit'))
...
WebUI.click(findTestObject('CMS/Goods/DeleteModifications/div_checkbox_of_modifications'))

WebUI.click(findTestObject('CMS/Goods/DeleteGoodsInSet/button_delete_goods_in_set'))

WebUI.click(findTestObject('CMS/Form/DeleteForm/span_ok'))

WebUI.verifyTextNotPresent(GoodsName, false)
