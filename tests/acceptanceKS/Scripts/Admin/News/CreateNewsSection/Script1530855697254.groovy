 /**
 * @description Создание раздела новостей
 * @step Жмем кнопку добавить раздел
 * @step Заполнение полей название и псевдоним раздела
 * @step Раскрытие списка тип раздела и выбор второй строчки в выпадающем окне
...
WebUI.setText(findTestObject('CMS/News/CreateNewNews/CreateNewSection/input_title_section'), DataNews.titlesection)

WebUI.setText(findTestObject('CMS/Tree/NewSection/input_alias'), DataNews.aliassection)

WebUI.click(findTestObject('CMS/News/CreateNewNews/CreateNewSection/span_section_type'))

WebUI.click(findTestObject('CMS/News/CreateNewNews/CreateNewSection/span_section_type_news'))
