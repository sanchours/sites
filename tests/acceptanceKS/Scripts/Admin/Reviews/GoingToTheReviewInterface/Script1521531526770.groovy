/**
 * @description Переход на интерфейс отзывов
 * @step Нажатие на пункт "Верхенее меню"
 * @step Нажатие на пункт "Покуптелю"
 * @step Нажатие на пункт "Отзывы"
 * @step Переход на таб "Отзывы"
 */
