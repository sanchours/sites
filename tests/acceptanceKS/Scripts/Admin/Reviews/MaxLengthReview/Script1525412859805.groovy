 /**
 * @description Максимальная длина отзыва
 * @step Переход в панель управления
 * @step Переход в модуль "Формы"
 * @step Переход в редактирование формы "Отзывы"
 * @step Переход в редактирование поля "Ваше мнение"
 * @step Установка значения парамера "Максимальная длина" = 3
 * @step Нажатие на кнопку сохранить
 * @step Переход в верхнее меню
 * @step Переход на главную страницу по ссылке из вкладки редактор
 ...
 * @step - Заполнение обязательного поля "Ваше мнение" текстом из более 3х симвовлов
 ...
 * @step - Установка галочки согласия с политикой конфиденциальности
 * @step - Нажатие на кнопку "Отправить"
 * @step Проверка наличия блока уведомления о невалидном значении поля "Ваше мнение"
 * @step Заполнение обязательного поля "Ваше мнение" текстом из 3х симвовлов
 * @step Нажатие на кнопку "Отправить"
...
WebUI.click(findTestObject('CMS/Reviews/MaxLengthReview/div_forms'))

WebUI.doubleClick(findTestObject('CMS/Reviews/MaxLengthReview/div_review_form'))

WebUI.doubleClick(findTestObject('CMS/Reviews/MaxLengthReview/div_text_review'))

WebUI.setText(findTestObject('CMS/Reviews/MaxLengthReview/input_param_maxlength'), '3')

WebUI.click(findTestObject('CMS/Reviews/MaxLengthReview/span_save'))

WebUI.click(findTestObject('CMS/Reviews/MaxLengthReview/div_section_list'))
...
WebUI.verifyElementVisible(findTestObject('CMS/Reviews/MaxLengthReview/div_error_validation'))

WebUI.setText(findTestObject('Site/CreateReview/textarea_content'), 'ТРИ')
