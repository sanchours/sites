/**
 * @description Установка в разделе формы
 * @step Переход в таб настройки формы к разделу
 * @step Установка в разделе тестовой формы "Test Form"
...
WebUI.click(findTestObject('Object Repository/CMS/TabSection/li_test_form'))
