...
class TestHelper
{
    ...
    public static function init()
    {
        ...
        require_once __DIR__ . '/test_model/TestArTable.php';
        require_once __DIR__ . '/test_model/TestArRow.php';
        ...
        Query::SQL("INSERT INTO test_ar2 (`id`,`info`) VALUES (NULL,'smalltext1'), (NULL,'smalltext2');");
    }

    /**
     * Отдает запросник для тестовой таблицы.
     *
     * @return \unit\base\orm\test_model\TestArTable
     */
    public static function getTable()
    {
        return new test_model\TestArTable();
    }
}
